...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    include_once('UserCreationModel');//model
    $user = new UserCreation();
    $user->addPatient($fname, $lname, $DOB, $UserTypeID, $uname, $password, $email, $phoneNumber, $DayWorking, $StartTime, $EndTime, $Gender, $Salary);
}
?>